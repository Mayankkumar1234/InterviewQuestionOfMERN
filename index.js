...
// // console.log("jatin">9)  // false
// // console.log("jatin"<9);   //false

// // When we compare a number with string it will always return false..
...
// // console.log(name);  // It will print string because string are immutable...

// // let str = "my name is mayank kumar";
...
// let arr1 = [, , , ,]; // If the last element in empty it wont be consider as array length..
